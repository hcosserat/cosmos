...
public:
    ...
    void update_a_gravity_2(const Vector2<double> &source_pos, const Vector2<double> &dest_pos,
                             double dest_m, double lin_factor);
